...
- вертикального меню [vmenu](/_data/vmenu.yml)
- список ссылок, показываемых в углу отладочной (не на GitHub Pages) версии сайта [devlinks](/_data/devlinks.yml)

Если какой-то текст в YAML стал не нужен (в отдельном YAML-файле или внутри YAML Front Matter в заголовке файла),
